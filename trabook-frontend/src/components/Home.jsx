      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-2 gap-0 py-2">
          <div className="col-span-1 pl-48 pr-20 justify-center items-center">
            ...
            <a
              className="btn btn-icon text-md px-8 py-2 bg-slate-50 text-orange-500 hover:bg-orange-500 hover:text-white border-2 border-orange-500 shadow-md rounded-md relative inline-block mb-0 top-[4rem]"
              href="/plans"
            >
              Discover now
            </a>
          ...
          <div className="col-span-2 flex justify-center mt-16 mb-4 py-24">
            <div className="grid grid-cols-4 gap-2 relative bg-slate-50 rounded-lg border px-3 py-4">
              <div className="flex items-center">
                <span className="mr-2">
                  <select
                    className="bg-gray-50 p-2 rounded-md text-lg text-black caret-red-200"
                    defaultValue=""
                  >
              ...
              <a
                className="btn btn-icon text-md px-10 py-3 mt-1 bg-orange-500 hover:bg-orange-400 text-white shadow-md rounded-md"
                href="/tours"
              >
                Explore now
              </a>
