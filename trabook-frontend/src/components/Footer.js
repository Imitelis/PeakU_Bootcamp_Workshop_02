      ...
      <div className="relative inline-block mb-0 top-[-8rem] left-[0rem] w-90 h-80 bg-orange-500 rounded-2xl overflow-hidden flex flex-col justify-center items-center">
        ...
        <div className="flex">
          <svg
            ...
            width="20"
            height="20"
            className="relative h-8 inline-block mb-0 top-[1.8rem] left-[1.6rem] z-20"
            fill="#6b7280"
            viewBox="0 0 32 32"
          >
          ...
          />
          <button className="relative h-8 inline-block mb-0 top-[1.8rem] left-[-5.7rem] text-md py-1 px-2 bg-orange-500 hover:bg-orange-400 text-white shadow-md rounded-md z-20">
            Subscribe
          </button>
        </div>
        <img
          ...
          <div className="flex items-start w-40 gap-2">
            <div className="w-1/3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="btn btn-icon btn-md bg-slate-50 shadow-md rounded-full hover:bg-orange-500 hover:text-white transition-colors duration-300"
              >
