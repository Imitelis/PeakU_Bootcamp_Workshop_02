const PlanCard = ({ plan }) => {
    return (
      <div className="bg-none hover:bg-white h-90 rounded-lg shadow-md overflow-hidden z-0 group">
        <div className="relative overflow-hidden flex items-center justify-center flex-col w-100 h-50 rounded-lg">
        <div className="w-full h-full">
          ...
          <div className="absolute w-full h-full top-0 bottom-0 left-0 right-0 flex items-center justify-center">
            <a className="text-xl px-3 py-2 bg-orange-500 hover:bg-orange-400 text-white shadow-md rounded-md hidden group-hover:block" href="/plans">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-1 mt-8 ml-2 px-2">
            <p className="text-2xl font-semibold mb-2">{plan.city}</p>
          </div>
          <div className="flex items-center gap-1 mt-8 ml-16 px-2">
            <svg
          ...
          <div className="flex items-center gap-1 mt-0 ml-2 px-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
              height="28"
            ...
            <div className="text-gray-500 text-lg">{plan.country}</div>
          </div>
          <div className="flex items-center gap-1 ml-8 mt-0 px-2">
